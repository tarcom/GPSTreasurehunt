...
<p id="demo">GPS Thresure demo page</p>

<p>access db on aogj.com: <a target="_blank" href="http://mysql06.cliche.dk">http://mysql06.cliche.dk</a></p>

<!--<button onclick="getLocation()">Try It</button>-->
<button onclick="persistGpsPosition()">persistGpsPosition</button>
...
<form id="saveImageForm" name="saveImageForm" action="" enctype="multipart/form-data" method="POST">
    ...
    <br>
    <input type="text" id="treasureImageId" name="imageId" value="<?php echo uniqid(); ?>"/>
    <br>
